...
$parm_error_log = '/tmp/assign_mid_bed.log';
...
<form name="form" method="post" action="assign_mid_do_bed.php">
...
<?php
        ...
        $query_RsCourse = "SELECT bed FROM bed where mid_night='0' ";
   ...
   echo '<option value="-">'. '--' .'</option>';
      while ($row = mysql_fetch_array($RsCourse, MYSQL_ASSOC))
      {
        ...
        {
        echo '所有大夜班病床已派班完畢'; // no rows in tbl_course
        }
        echo '</td>';
