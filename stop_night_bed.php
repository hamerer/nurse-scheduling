...
$parm_error_log = '/tmp/stop_day_bed.log';
...
<form name="form" method="post" action="stop_night_do_bed.php">
...
<?php
        ...
        $query_RsCourse = "SELECT bed FROM bed where night='1' ";
   ...
   echo '<option value="-">'. '--' .'</option>';
      while ($row = mysql_fetch_array($RsCourse, MYSQL_ASSOC))
      {
        ...
        {
        echo '所有夜班病床已分配完畢'; // no rows in tbl_course
        }
        echo '</td>';
