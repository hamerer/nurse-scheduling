...
<head>
<title>系統匯入護理站排班系統</title>

<link rel=stylesheet href="button.css" type="text/css">
</head>

<body>
<Left><H2  align="middle"  class="style1">系統匯入護理站排班系統</H2>
<HR>
<table align=center  border=0 width="40%">
<tr>
<td>
<a href="#" onclick="window.open('./before.php', 'Before', config='height=500,width=500');"><img src="./backward.jpg" alt="Smiley face" width="84" height="30">
</a>
</td>
<td>
<a href="#" onclick="window.open('./yestoday', 'Yestoday', config='height=500,width=500');">
