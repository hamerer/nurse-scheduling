...
$result = mysql_query("SELECT id,day_nurse,night_nurse,mid_nurse FROM bed WHERE id BETWEEN '1001' AND '1003'") ;
...
while ($row=mysql_fetch_array($result)){
  	echo "<tr>";
		echo "<th width=20%> $row[0]</font> </th>";
    	echo "<td width=20%>  $row[1] </font> </td>";
    	echo "<td width=20%> $row[2] </font> </td>";
    	echo "<td width=20%> $row[3] </font> </td>";
  	echo "</tr>";
}
...
$result = mysql_query("SELECT id,day_nurse,night_nurse,mid_nurse FROM bed WHERE id BETWEEN '1006' AND '1019'") ;
while ($row=mysql_fetch_array($result)){
  	echo "<tr>";
		echo "<th width=20%>  $row[0] </th>";
    	echo "<td width=20%>  $row[1]  </td>";
