...
$result = mysql_query("SELECT id,day_nurse,night_nurse,mid_nurse FROM bed WHERE id BETWEEN '1005' AND '1008'") ;
while ($row=mysql_fetch_array($result)){
  	echo "<tr>";
		echo "<th width=20%>  $row[0] </th>";
    	echo "<td width=20%>  $row[1]  </td>";
...
$result = mysql_query("SELECT id,day_nurse,night_nurse,mid_nurse FROM bed WHERE id='1009'") ;
while ($row=mysql_fetch_array($result)){
  	echo "<tr>";
		echo "<th width=20%><font color=\"RED\">  $row[0]</font> </th>";
    	echo "<td width=20%><font color=\"RED\">  $row[1] </font> </td>";
...
$result = mysql_query("SELECT id,day_nurse,night_nurse,mid_nurse FROM bed WHERE id BETWEEN '1010' AND '1019'") ;
while ($row=mysql_fetch_array($result)){
  	echo "<tr>";
		echo "<th width=20%>  $row[0] </th>";
    	echo "<td width=20%>  $row[1]  </td>";
