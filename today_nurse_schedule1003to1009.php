...
$result = mysql_query("SELECT id,day_nurse,night_nurse,mid_nurse FROM bed WHERE id BETWEEN '1001' AND '1002'") ;
...
$result = mysql_query("SELECT id,day_nurse,night_nurse,mid_nurse FROM bed WHERE id BETWEEN '1004' AND '1008'") ;
while ($row=mysql_fetch_array($result)){
  	echo "<tr>";
		echo "<th width=20%>  $row[0] </th>";
    	echo "<td width=20%>  $row[1]  </td>";
